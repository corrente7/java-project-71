...
public class Parser {
    ...
    private static Map getJsonData(String filepath) throws Exception {
    ...
    private static Map getYamlData(String filepath) throws Exception {
    ...
    static Map detectTypeFile(String filepath) throws Exception {
